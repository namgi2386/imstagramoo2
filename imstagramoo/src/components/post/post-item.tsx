...
import LikePostButton from "@/components/post/like-post";
  ...
  return (
    <div className="flex flex-col gap-4 border-b pb-8">
      ...
      <div className="flex gap-2">
        {/* 3-1. 좋아요 버튼 */}
        <LikePostButton id={post.id} likeCount={post["like-count"]} isLiked={post.isLiked} />
